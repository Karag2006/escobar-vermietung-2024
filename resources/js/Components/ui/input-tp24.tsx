            ...
            <div className={cn("group relative", className)}>
                {label && label !== "" && (
                    <label
                        htmlFor={id}
                        className={cn(
                            "absolute bottom-1 left-0 text-gray-300 group-hover:text-gray-600 group-focus-within:text-blue-400 group-focus-within:text-xs group-focus-within:bottom-7 transition-all group-hover:cursor-text",
                            value && value !== "" && "text-xs bottom-7",
